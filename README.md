...
یک اپلیکیشن دسکتاپ تمام‌عیار برای خرید و فروش کالای دست‌دوم. بک‌اند با Spring Boot یک REST API کامل روی پورت 8080 ارائه می‌دهد و فرانت‌اند JavaFX با تم تیره بنفش–طلایی و چیدمان راست‌به‌چپ (RTL) با آن ارتباط می‌گیرد.
